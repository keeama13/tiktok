...
public class SpriteGameObject : GameObject
{
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        if (layer < 80) // belangrijke objecten hebben een hogere layer waarde deze objecten moeten niet mee bewegen
        {
            sprite.Draw(spriteBatch, new Vector2(this.GlobalPosition.X - Camera.position.X, this.GlobalPosition.Y), origin);
        }
        else // is een object niet belangirjk moet ie wel meebewegen
        {
