...
partial class Level : GameObjectList
{
    ...
    public Level(int levelIndex)
    {
        ...
        SpriteGameObject backgroundSky = new SpriteGameObject("Backgrounds/spr_sky", 0 ,"backgroundSky");
        backgroundSky.Position = new Vector2(Camera.position.X, GameEnvironment.Screen.Y - backgroundSky.Height);
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            mountain.Position = new Vector2((float)GameEnvironment.Random.NextDouble() * GameEnvironment.Screen.X + Camera.position.X - mountain.Width / 2, 
